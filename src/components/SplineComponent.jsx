...
const SplineComponent = () => {
  ...
  <Spline scene="https://prod.spline.design/9IzpX7kcvJsv4W-f/scene.splinecode" />
    <div className="p-4 border shadow-lg bg-white rounded-b-lg rounded-br-lg">
      <h2 className="text-xl flex justify-between font-neonRave mb-2">StreamLine <br /> Studios  <span className='text-sm font-serif text-roseImaginatio-dark font-bold'>Interactua con el modelo</span></h2>
...
<Spline scene="https://prod.spline.design/SOzSCtn2fSv4JFsy/scene.splinecode" />
    <div className="p-4 border shadow-lg bg-white rounded-b-lg rounded-br-lg ">
    <h2 className="text-xl flex justify-between font-neonRave mb-2">Womenize <br />Latam  <span className='text-sm font-serif text-roseImaginatio-dark font-bold'>Interactua con el modelo</span></h2>
      <p className="text-gray-600 text-sm ">
